...
import 'inner_pages/RequestModule/requests_screen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void getCurrentLocation() async {
    ...
    //   currentPostion = await geoServices.determineLastPosition();
    // }
    ...
    switch (index) {
      ...
      case 1:
        return FadeInUp(
            ...
            child: Home(currentPostion: currentPostion));
      case 2:
        return UsuariosPage();

//         return ChatListScreen(usuario: authService.usuario);
      default:
        return FadeInUp(
            duration: Duration(seconds: 1),
            child: Home(currentPostion: currentPostion));
